...
using PayVantage.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace PayVantage.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:PayVantage.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
